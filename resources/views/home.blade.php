...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
      ...
      {{-- navbar kecil --}}
       ...
       {{-- navbar utama --}}
        <nav class="navbar navbar-expand-lg navbar-light bg-light bg-warning" style="2%">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">Todo list Al</a>
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="d-grid gap-2">
                                    <button type="submit" name="add post" class="btn-btn-primary">Tambah Todo List</button>
                                </div>
                            </form>
                        </div>
                    </div> <br><br>
        ...
        {{-- form tambah --}}
         {{-- todo list pending --}}
                    ...
                    <div class="card bg-danger shadow-lg-border-0 ">
                        <div class="card-body">
                            <h3 class="text-light text-center">LIST PENDING TO DO LIST</h3>
                            <ul class="list-group">
                ...
                <ul class="list-group">
                    <li class="list-group-item">
                        ...
                        <div style="float: right">
                          ...
                          <a href="" class="btn btn-danger badge bg-danger">hapus</a>
                        </div>
                    </li>
                </ul>
                </div>
